...
public interface SPfinancial {
    ...
    public com.swifta.subsidiary.mats.serviceprovider.operation.spfinancial.v1.Transfertobankresponse transfertobankrequest(
        ...
        @WebParam(name = "amount", targetNamespace = "")
        java.lang.String amount,
        @WebParam(name = "narration", targetNamespace = "")
    ...
    @WebMethod(action = "cashoutunregisteredrequest")
    @RequestWrapper(localName = "cashoutunregisteredrequest", targetNamespace = "http://swifta.com/subsidiary/mats/serviceprovider/operation/spfinancial/v1.0", className = "com.swifta.subsidiary.mats.serviceprovider.operation.spfinancial.v1.Cashoutunregisteredrequest")
    @ResponseWrapper(localName = "cashoutunregisteredrequestResponse", targetNamespace = "http://swifta.com/subsidiary/mats/serviceprovider/operation/spfinancial/v1.0", className = "com.swifta.subsidiary.mats.serviceprovider.operation.spfinancial.v1.CashoutunregisteredrequestResponse")
    @WebResult(name = "return", targetNamespace = "")
    public com.swifta.subsidiary.mats.serviceprovider.operation.spfinancial.v1.Cashoutresponse cashoutunregisteredrequest(
        ...
        @WebParam(name = "referencenumber", targetNamespace = "")
        java.lang.String referencenumber,
        @WebParam(name = "referencecode", targetNamespace = "")
